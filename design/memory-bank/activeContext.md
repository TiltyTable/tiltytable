...
- 2026-07-14 | Experimental MCS=4 firmware now supports runtime `PROFILE speed accel` (1–90°/s, 1–500°/s²), flashed and verified through persistent supervisor. Added `stewart_exp_tune.py` for manual four-direction ball-roll threshold trials, runtime profile changes, supervised agility reversals, operator ratings, and JSON results at `calibration/stewart_game_tuning.json`.
