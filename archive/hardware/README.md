...
- `archive/arduino/pca9685_servo_bridge/pca9685_servo_bridge.ino` (archived; was early Uno R3 servo bridge).
...
1. Open `archive/arduino/pca9685_servo_bridge/pca9685_servo_bridge.ino` in the Arduino IDE (archived; prefer `arduino/servo_calib/` for the live R4).
