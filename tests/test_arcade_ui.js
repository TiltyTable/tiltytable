...
assert.strictEqual(backIntent("survival_fail"), "abandon");
assert.strictEqual(backIntent("time_up"), "abandon");
assert.strictEqual(backIntent("level_clear"), "abandon");
assert.strictEqual(backIntent("level_score"), "abandon");
